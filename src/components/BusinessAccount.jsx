    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gray-100 px-4">
            <div className="w-full max-w-sm">
                <h2 className="text-2xl font-bold mb-5">Create Business Account</h2>
                <form onSubmit={handleSignUp}>
                    <div className="mb-4">
                        <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="busiessName">
                            User Name
                        </label>
                        <input
                            type="text"
                            name="busiessName"
                            id="busiessName"
                            placeholder="Your Busiess Name"
                            value={formData.busiessName}
